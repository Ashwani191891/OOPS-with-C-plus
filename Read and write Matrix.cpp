...
int row_m,col_n,matrix[sizeof(row_m)][sizeof(col_n)];


// read_matrix function -- to get input of matrix order and matrix elements from keyboard

int read_matrix(int matrix[sizeof(row_m)][sizeof(col_n)])
{
    int i,j;
...
int display_matrix(int matrix[sizeof(row_m)][sizeof(col_n)])
{
    int i,j;
